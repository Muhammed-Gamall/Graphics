...
namespace Graphics
{
    class Renderer
    {
        ...
        public float translationX=0,   //transition
                     translationY=0, 
                     translationZ=0;

        public float scalingX = 1,   //Scaling 
                     scalingY = 1,
                     scalingZ = 1;
        ...
        public void Initialize()
        {
          ...
          0,1,0,
           ...
           0,1,0,
            ...
            Gl.glUniformMatrix4fv(ShaderViewMatrixID, 1, Gl.GL_FALSE, ViewMatrix.to_array());  //fixed
        ...
        public void Update()
        {
            ...
            transformations.Add(glm.scale(new mat4(1), new vec3(scalingX, scalingY, scalingZ)));
